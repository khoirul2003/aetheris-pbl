      ...
      <nav className="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto custom-scrollbar">
        ...
        {role === "admin" ? (
          ...
          <>
            ...
            >
              <Home size={18} strokeWidth={isActive("/dashboard/admin") ? 2.5 : 2} /> 
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm cursor-pointer
                ${isActive("/dashboard/admin/alerts") 
                  ...
                  : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium"}`}
            >
              <ShieldAlert size={18} strokeWidth={isActive("/dashboard/admin/alerts") ? 2.5 : 2} /> 
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm cursor-pointer
                ${isActive("/dashboard/admin/analytics") 
                  ...
                  : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium"}`}
            >
              <BarChart2 size={18} strokeWidth={isActive("/dashboard/admin/analytics") ? 2.5 : 2} /> 
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm cursor-pointer
                ${isActive("/dashboard/admin/logs") 
                  ...
                  : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium"}`}
            >
              <History size={18} strokeWidth={isActive("/dashboard/admin/logs") ? 2.5 : 2} /> 
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm cursor-pointer
                ${isActive("/dashboard/admin/settings") 
                  ...
                  : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium"}`}
            >
              <Settings size={18} strokeWidth={isActive("/dashboard/admin/settings") ? 2.5 : 2} /> 
            ...
            <button 
              ...
              className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all text-sm cursor-pointer
                ${isActive("/dashboard/user/reports") 
                  ...
                  : "text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-medium"}`}
            >
              <BarChart2 size={18} strokeWidth={isActive("/dashboard/user/reports") ? 2.5 : 2} /> 
              <span>Laporan</span>
            </button>
