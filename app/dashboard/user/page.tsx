...
export default function UserDashboard() {
  ...
  return (
    <div className="flex bg-[#FDFBF7] min-h-screen font-sans text-slate-900 antialiased overflow-x-hidden">
      ...
      {/* PERBAIKAN: md:ml-64 untuk desktop, pb-24 untuk memberi ruang bottom nav mobile */}
      <main className="md:ml-64 pt-24 px-4 md:px-8 pb-24 md:pb-8 w-full max-w-6xl mx-auto box-border">
        ...
        {/* KARTU RINGKASAN ATAS: Dioptimalkan grid-cols-2 untuk HP, lg:grid-cols-4 untuk laptop */}
