            ...
            {sensors.map((sensor) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="space-y-2.5 bg-white/80 backdrop-blur-sm p-4 rounded-xl border border-slate-100/50 mb-4 flex-grow flex flex-col justify-center shadow-inner">
                    <div className="flex justify-between items-center text-xs md:text-sm">
                      <span className="text-slate-500 font-semibold">Kadar Gas Total:</span>
                    ...
                    {/* MENAMPILKAN STATUS LPG LEVEL SECARA STRING DARI FIREBASE */}
                    <div className="flex justify-between items-center text-xs md:text-sm border-t border-slate-50 pt-2">
                      <span className="text-slate-500 font-semibold">Status Kebocoran LPG:</span>
                    ...
                    {/* MENAMPILKAN STATUS SMOKE LEVEL SECARA STRING DARI FIREBASE */}
                    <div className="flex justify-between items-center text-xs md:text-sm border-t border-slate-50 pt-2">
                      <span className="text-slate-500 font-semibold">Kondisi Kepekatan Asap:</span>
                  ...
                  <div className="pt-3 border-t border-t-slate-200/60 flex items-center justify-between text-[9px] md:text-[10px] text-slate-400 font-bold tracking-wide gap-1">
