  ...
  const handleAddAdminSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingAdminId) {
        ...
        showToast("Akun admin untuk " + newAdmin.name + " berhasil didaftarkan ke sistem Firebase!");
      }
  ...
  return (
    <div className="flex bg-slate-50 min-h-screen font-sans text-slate-800 overflow-y-scroll relative select-none" style={{ scrollbarGutter: "stable" }}>
      ...
      <div className="flex flex-col flex-grow min-w-0">
        ...
        <main className="md:ml-64 pt-24 px-8 pb-8 w-auto transition-all flex-grow">
