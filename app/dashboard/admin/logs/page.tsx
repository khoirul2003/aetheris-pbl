                  ...
                  {currentRows.length > 0 ? (
                    currentRows.map((log, i) => (
                      <tr key={i} className="hover:bg-slate-50/50 transition-colors">
                        <td className="px-6 py-4 font-mono text-xs font-bold text-slate-700">{log.id}</td>
                        ...
                        <td className="px-6 py-4 text-blue-600 font-medium">{log.target}</td>
                        <td className="px-6 py-4 text-xs text-slate-500 max-w-sm">{log.desc}</td>
                      </tr>
                    ))
                  ) : (
                    <tr>
